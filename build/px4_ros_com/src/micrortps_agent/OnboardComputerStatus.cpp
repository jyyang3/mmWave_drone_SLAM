...
{
    // m_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@24959ca4
    m_timestamp = 0;
    // m_uptime com.eprosima.idl.parser.typecode.PrimitiveTypeCode@10289886
    m_uptime = 0;
    // m_type com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5c86dbc5
    m_type = 0;
    // m_cpu_cores com.eprosima.idl.parser.typecode.AliasTypeCode@461ad730
    memset(&m_cpu_cores, 0, (8) * 1);
    // m_cpu_combined com.eprosima.idl.parser.typecode.AliasTypeCode@4ee203eb
    memset(&m_cpu_combined, 0, (10) * 1);
    // m_gpu_cores com.eprosima.idl.parser.typecode.AliasTypeCode@1a5a4e19
    memset(&m_gpu_cores, 0, (4) * 1);
    // m_gpu_combined com.eprosima.idl.parser.typecode.AliasTypeCode@4ee203eb
    memset(&m_gpu_combined, 0, (10) * 1);
    // m_temperature_board com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7068e664
    m_temperature_board = 0;
    // m_temperature_core com.eprosima.idl.parser.typecode.AliasTypeCode@60db1c0e
    memset(&m_temperature_core, 0, (8) * 1);
    // m_fan_speed com.eprosima.idl.parser.typecode.AliasTypeCode@3e78b6a5
    memset(&m_fan_speed, 0, (4) * 2);
    // m_ram_usage com.eprosima.idl.parser.typecode.PrimitiveTypeCode@769a1df5
    m_ram_usage = 0;
    // m_ram_total com.eprosima.idl.parser.typecode.PrimitiveTypeCode@41f69e84
    m_ram_total = 0;
    // m_storage_type com.eprosima.idl.parser.typecode.AliasTypeCode@7975d1d8
    memset(&m_storage_type, 0, (4) * 4);
    // m_storage_usage com.eprosima.idl.parser.typecode.AliasTypeCode@7975d1d8
    memset(&m_storage_usage, 0, (4) * 4);
    // m_storage_total com.eprosima.idl.parser.typecode.AliasTypeCode@7975d1d8
    memset(&m_storage_total, 0, (4) * 4);
    // m_link_type com.eprosima.idl.parser.typecode.AliasTypeCode@2438dcd
    memset(&m_link_type, 0, (6) * 4);
    // m_link_tx_rate com.eprosima.idl.parser.typecode.AliasTypeCode@2438dcd
    memset(&m_link_tx_rate, 0, (6) * 4);
    // m_link_rx_rate com.eprosima.idl.parser.typecode.AliasTypeCode@2438dcd
    memset(&m_link_rx_rate, 0, (6) * 4);
    // m_link_tx_max com.eprosima.idl.parser.typecode.AliasTypeCode@2438dcd
    memset(&m_link_tx_max, 0, (6) * 4);
    // m_link_rx_max com.eprosima.idl.parser.typecode.AliasTypeCode@2438dcd
