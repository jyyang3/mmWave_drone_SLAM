...
px4_msgs::msg::TrajectoryWaypoint::TrajectoryWaypoint()
{
    ...
    m_timestamp = 0;
    // m_position com.eprosima.idl.parser.typecode.AliasTypeCode@4d5b6aac
    memset(&m_position, 0, (3) * 4);
    // m_velocity com.eprosima.idl.parser.typecode.AliasTypeCode@4d5b6aac
    memset(&m_velocity, 0, (3) * 4);
    // m_acceleration com.eprosima.idl.parser.typecode.AliasTypeCode@4d5b6aac
    memset(&m_acceleration, 0, (3) * 4);
    // m_yaw com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3e84448c
    m_yaw = 0.0;
    // m_yaw_speed com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4a7f959b
    m_yaw_speed = 0.0;
    // m_point_valid com.eprosima.idl.parser.typecode.PrimitiveTypeCode@429bffaa
    m_point_valid = false;
    // m_type com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5403f35f
    m_type = 0;
