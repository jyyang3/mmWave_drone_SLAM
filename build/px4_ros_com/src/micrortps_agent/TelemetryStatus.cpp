...
{
    // m_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@766653e6
    m_timestamp = 0;
    // m_type com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4e07b95f
    m_type = 0;
    // m_mode com.eprosima.idl.parser.typecode.PrimitiveTypeCode@28b46423
    m_mode = 0;
    // m_flow_control com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7fc4780b
    m_flow_control = false;
    // m_forwarding com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3b79fd76
    m_forwarding = false;
    // m_mavlink_v2 com.eprosima.idl.parser.typecode.PrimitiveTypeCode@48c76607
    m_mavlink_v2 = false;
    // m_ftp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@43599640
    m_ftp = false;
    // m_streams com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1f81aa00
    m_streams = 0;
    // m_data_rate com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6b6776cb
    m_data_rate = 0.0;
    // m_rate_multiplier com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1863d2fe
    m_rate_multiplier = 0.0;
    // m_tx_rate_avg com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1787bc24
    m_tx_rate_avg = 0.0;
    // m_tx_error_rate_avg com.eprosima.idl.parser.typecode.PrimitiveTypeCode@544d57e
    m_tx_error_rate_avg = 0.0;
    // m_tx_message_count com.eprosima.idl.parser.typecode.PrimitiveTypeCode@55c53a33
    m_tx_message_count = 0;
    // m_tx_buffer_overruns com.eprosima.idl.parser.typecode.PrimitiveTypeCode@53b7f657
    m_tx_buffer_overruns = 0;
    // m_rx_rate_avg com.eprosima.idl.parser.typecode.PrimitiveTypeCode@797b0699
    m_rx_rate_avg = 0.0;
    // m_rx_message_count com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5a37d3ed
    m_rx_message_count = 0;
    // m_rx_message_lost_count com.eprosima.idl.parser.typecode.PrimitiveTypeCode@26df6e3a
    m_rx_message_lost_count = 0;
    // m_rx_buffer_overruns com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4a3631f8
    m_rx_buffer_overruns = 0;
    // m_rx_parse_errors com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6b58b9e9
    m_rx_parse_errors = 0;
    // m_rx_packet_drop_count com.eprosima.idl.parser.typecode.PrimitiveTypeCode@f14a7d4
    m_rx_packet_drop_count = 0;
    // m_rx_message_lost_rate com.eprosima.idl.parser.typecode.PrimitiveTypeCode@52e7a6b2
    m_rx_message_lost_rate = 0.0;
    // m_heartbeat_type_antenna_tracker com.eprosima.idl.parser.typecode.PrimitiveTypeCode@29a5f4e7
    m_heartbeat_type_antenna_tracker = false;
    // m_heartbeat_type_gcs com.eprosima.idl.parser.typecode.PrimitiveTypeCode@79c97cb
    m_heartbeat_type_gcs = false;
    // m_heartbeat_type_onboard_controller com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2d9caaeb
    m_heartbeat_type_onboard_controller = false;
    // m_heartbeat_type_gimbal com.eprosima.idl.parser.typecode.PrimitiveTypeCode@42a15bdc
    m_heartbeat_type_gimbal = false;
    // m_heartbeat_type_adsb com.eprosima.idl.parser.typecode.PrimitiveTypeCode@44a59da3
    m_heartbeat_type_adsb = false;
    // m_heartbeat_type_camera com.eprosima.idl.parser.typecode.PrimitiveTypeCode@27e47833
    m_heartbeat_type_camera = false;
    // m_heartbeat_type_parachute com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6f6745d6
    m_heartbeat_type_parachute = false;
    // m_heartbeat_type_open_drone_id com.eprosima.idl.parser.typecode.PrimitiveTypeCode@27508c5d
    m_heartbeat_type_open_drone_id = false;
    // m_heartbeat_component_telemetry_radio com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4f704591
    m_heartbeat_component_telemetry_radio = false;
    // m_heartbeat_component_log com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4b5189ac
    m_heartbeat_component_log = false;
    // m_heartbeat_component_osd com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1e4d3ce5
    m_heartbeat_component_osd = false;
    // m_heartbeat_component_obstacle_avoidance com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3ddc6915
    m_heartbeat_component_obstacle_avoidance = false;
    // m_heartbeat_component_vio com.eprosima.idl.parser.typecode.PrimitiveTypeCode@704deff2
    m_heartbeat_component_vio = false;
    // m_heartbeat_component_pairing_manager com.eprosima.idl.parser.typecode.PrimitiveTypeCode@379614be
    m_heartbeat_component_pairing_manager = false;
    // m_heartbeat_component_udp_bridge com.eprosima.idl.parser.typecode.PrimitiveTypeCode@404bbcbd
    m_heartbeat_component_udp_bridge = false;
    // m_heartbeat_component_uart_bridge com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1e81f160
    m_heartbeat_component_uart_bridge = false;
    // m_avoidance_system_healthy com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1acaf3d
    m_avoidance_system_healthy = false;
    // m_open_drone_id_system_healthy com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6986852
    m_open_drone_id_system_healthy = false;
    // m_parachute_system_healthy com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1bab8268
...
px4_msgs::msg::TelemetryStatus::TelemetryStatus(const TelemetryStatus &x)
{
    ...
    m_heartbeat_type_open_drone_id = x.m_heartbeat_type_open_drone_id;
...
void px4_msgs::msg::TelemetryStatus::serialize(eprosima::fastcdr::Cdr &scdr) const
{
    ...
    scdr << m_heartbeat_type_open_drone_id;
...
void px4_msgs::msg::TelemetryStatus::deserialize(eprosima::fastcdr::Cdr &dcdr)
{
    ...
    dcdr >> m_heartbeat_type_open_drone_id;
 ...
 */
void px4_msgs::msg::TelemetryStatus::heartbeat_type_open_drone_id(bool _heartbeat_type_open_drone_id)
{
m_heartbeat_type_open_drone_id = _heartbeat_type_open_drone_id;
}
 ...
 */
bool px4_msgs::msg::TelemetryStatus::heartbeat_type_open_drone_id() const
{
    return m_heartbeat_type_open_drone_id;
}
 ...
 */
bool& px4_msgs::msg::TelemetryStatus::heartbeat_type_open_drone_id()
{
    return m_heartbeat_type_open_drone_id;
}
 ...
 */
void px4_msgs::msg::TelemetryStatus::open_drone_id_system_healthy(bool _open_drone_id_system_healthy)
{
 ...
 */
bool px4_msgs::msg::TelemetryStatus::open_drone_id_system_healthy() const
{
 ...
 */
bool& px4_msgs::msg::TelemetryStatus::open_drone_id_system_healthy()
{
    return m_open_drone_id_system_healthy;
}
