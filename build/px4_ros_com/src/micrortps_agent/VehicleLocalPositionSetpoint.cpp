...
{
    // m_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@23202fce
    m_timestamp = 0;
    // m_x com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7b993c65
    m_x = 0.0;
    // m_y com.eprosima.idl.parser.typecode.PrimitiveTypeCode@37911f88
    m_y = 0.0;
    // m_z com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6f1c29b7
    m_z = 0.0;
    // m_vx com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4d6025c5
    m_vx = 0.0;
    // m_vy com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7f284218
    m_vy = 0.0;
    // m_vz com.eprosima.idl.parser.typecode.PrimitiveTypeCode@407a7f2a
    m_vz = 0.0;
    // m_acceleration com.eprosima.idl.parser.typecode.AliasTypeCode@4ea5b703
    memset(&m_acceleration, 0, (3) * 4);
    // m_thrust com.eprosima.idl.parser.typecode.AliasTypeCode@4ea5b703
    memset(&m_thrust, 0, (3) * 4);
    // m_yaw com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2a7ed1f
    m_yaw = 0.0;
    // m_yawspeed com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3fa247d1
    m_yawspeed = 0.0;
