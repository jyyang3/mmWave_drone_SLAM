...
namespace px4_msgs
{
    namespace msg
    {
        namespace VehicleCommand_Constants
        {
            ...
            const uint16_t VEHICLE_CMD_DO_GRIPPER = 211;
            ...
            const uint16_t VEHICLE_CMD_RUN_PREARM_CHECKS = 401;
            ...
            const uint16_t VEHICLE_CMD_DO_WINCH = 42600;
            ...
            const uint8_t GRIPPER_ACTION_RELEASE = 0;
            const uint8_t GRIPPER_ACTION_GRAB = 1;
