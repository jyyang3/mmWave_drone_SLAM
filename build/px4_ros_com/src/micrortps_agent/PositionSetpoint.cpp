...
{
    // m_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2bfc268b
    m_timestamp = 0;
    // m_valid com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2f8dad04
    m_valid = false;
    // m_type com.eprosima.idl.parser.typecode.PrimitiveTypeCode@29e495ff
    m_type = 0;
    // m_vx com.eprosima.idl.parser.typecode.PrimitiveTypeCode@41e1e210
    m_vx = 0.0;
    // m_vy com.eprosima.idl.parser.typecode.PrimitiveTypeCode@be35cd9
    m_vy = 0.0;
    // m_vz com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4944252c
    m_vz = 0.0;
    // m_velocity_valid com.eprosima.idl.parser.typecode.PrimitiveTypeCode@44821a96
    m_velocity_valid = false;
    // m_velocity_frame com.eprosima.idl.parser.typecode.PrimitiveTypeCode@732c2a62
    m_velocity_frame = 0;
    // m_alt_valid com.eprosima.idl.parser.typecode.PrimitiveTypeCode@272ed83b
    m_alt_valid = false;
    // m_lat com.eprosima.idl.parser.typecode.PrimitiveTypeCode@41fecb8b
    m_lat = 0.0;
    // m_lon com.eprosima.idl.parser.typecode.PrimitiveTypeCode@120f102b
    m_lon = 0.0;
    // m_alt com.eprosima.idl.parser.typecode.PrimitiveTypeCode@66498326
    m_alt = 0.0;
    // m_yaw com.eprosima.idl.parser.typecode.PrimitiveTypeCode@cad498c
    m_yaw = 0.0;
    // m_yaw_valid com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1e6454ec
    m_yaw_valid = false;
    // m_yawspeed com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2accdbb5
    m_yawspeed = 0.0;
    // m_yawspeed_valid com.eprosima.idl.parser.typecode.PrimitiveTypeCode@27ff5d15
    m_yawspeed_valid = false;
    // m_loiter_radius com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4e096385
    m_loiter_radius = 0.0;
    // m_loiter_direction_counter_clockwise com.eprosima.idl.parser.typecode.PrimitiveTypeCode@649bec2e
    m_loiter_direction_counter_clockwise = false;
    // m_acceptance_radius com.eprosima.idl.parser.typecode.PrimitiveTypeCode@693fe6c9
    m_acceptance_radius = 0.0;
    // m_cruising_speed com.eprosima.idl.parser.typecode.PrimitiveTypeCode@34f5090e
    m_cruising_speed = 0.0;
    // m_gliding_enabled com.eprosima.idl.parser.typecode.PrimitiveTypeCode@31e5415e
    m_gliding_enabled = false;
    // m_cruising_throttle com.eprosima.idl.parser.typecode.PrimitiveTypeCode@a2431d0
    m_cruising_throttle = 0.0;
    // m_disable_weather_vane com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1cbb87f3
...
px4_msgs::msg::PositionSetpoint::PositionSetpoint(const PositionSetpoint &x)
{
    ...
    m_loiter_direction_counter_clockwise = x.m_loiter_direction_counter_clockwise;
    m_acceptance_radius = x.m_acceptance_radius;
    m_cruising_speed = x.m_cruising_speed;
    m_gliding_enabled = x.m_gliding_enabled;
...
void px4_msgs::msg::PositionSetpoint::serialize(eprosima::fastcdr::Cdr &scdr) const
{
    ...
    scdr << m_loiter_direction_counter_clockwise;
    scdr << m_acceptance_radius;
    scdr << m_cruising_speed;
    scdr << m_gliding_enabled;
...
void px4_msgs::msg::PositionSetpoint::deserialize(eprosima::fastcdr::Cdr &dcdr)
{
    ...
    dcdr >> m_loiter_direction_counter_clockwise;
    dcdr >> m_acceptance_radius;
    dcdr >> m_cruising_speed;
    dcdr >> m_gliding_enabled;
...
/*!
 * @brief This function sets a value in member loiter_direction_counter_clockwise
 * @param _loiter_direction_counter_clockwise New value for member loiter_direction_counter_clockwise
 */
void px4_msgs::msg::PositionSetpoint::loiter_direction_counter_clockwise(bool _loiter_direction_counter_clockwise)
{
m_loiter_direction_counter_clockwise = _loiter_direction_counter_clockwise;
}

/*!
 * @brief This function returns the value of member loiter_direction_counter_clockwise
 * @return Value of member loiter_direction_counter_clockwise
 */
bool px4_msgs::msg::PositionSetpoint::loiter_direction_counter_clockwise() const
{
    return m_loiter_direction_counter_clockwise;
}

/*!
 * @brief This function returns a reference to member loiter_direction_counter_clockwise
 * @return Reference to member loiter_direction_counter_clockwise
 */
bool& px4_msgs::msg::PositionSetpoint::loiter_direction_counter_clockwise()
{
    return m_loiter_direction_counter_clockwise;
}
...
/*!
 * @brief This function sets a value in member gliding_enabled
 * @param _gliding_enabled New value for member gliding_enabled
 */
void px4_msgs::msg::PositionSetpoint::gliding_enabled(bool _gliding_enabled)
{
m_gliding_enabled = _gliding_enabled;
}

/*!
 * @brief This function returns the value of member gliding_enabled
 * @return Value of member gliding_enabled
 */
bool px4_msgs::msg::PositionSetpoint::gliding_enabled() const
{
    return m_gliding_enabled;
}

/*!
 * @brief This function returns a reference to member gliding_enabled
 * @return Reference to member gliding_enabled
 */
bool& px4_msgs::msg::PositionSetpoint::gliding_enabled()
{
    return m_gliding_enabled;
}
