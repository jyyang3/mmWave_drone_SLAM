...
{
    // m_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3e2059ae
    m_timestamp = 0;
    // m_gyro_rad com.eprosima.idl.parser.typecode.AliasTypeCode@398dada8
    memset(&m_gyro_rad, 0, (3) * 4);
    // m_gyro_integral_dt com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7cb502c
    m_gyro_integral_dt = 0;
    // m_accelerometer_timestamp_relative com.eprosima.idl.parser.typecode.PrimitiveTypeCode@275bf9b3
    m_accelerometer_timestamp_relative = 0;
    // m_accelerometer_m_s2 com.eprosima.idl.parser.typecode.AliasTypeCode@398dada8
    memset(&m_accelerometer_m_s2, 0, (3) * 4);
    // m_accelerometer_integral_dt com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1b8a29df
    m_accelerometer_integral_dt = 0;
    // m_accelerometer_clipping com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4fbe37eb
    m_accelerometer_clipping = 0;
    // m_gyro_clipping com.eprosima.idl.parser.typecode.PrimitiveTypeCode@12a94400
    m_gyro_clipping = 0;
    // m_accel_calibration_count com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6a47b187
    m_accel_calibration_count = 0;
    // m_gyro_calibration_count com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2049a9c1
...
px4_msgs::msg::SensorCombined::SensorCombined(const SensorCombined &x)
{
    ...
    m_gyro_clipping = x.m_gyro_clipping;
...
/*!
 * @brief This function sets a value in member gyro_clipping
 * @param _gyro_clipping New value for member gyro_clipping
 */
void px4_msgs::msg::SensorCombined::gyro_clipping(uint8_t _gyro_clipping)
{
m_gyro_clipping = _gyro_clipping;
}

/*!
 * @brief This function returns the value of member gyro_clipping
 * @return Value of member gyro_clipping
 */
uint8_t px4_msgs::msg::SensorCombined::gyro_clipping() const
{
    return m_gyro_clipping;
}

/*!
 * @brief This function returns a reference to member gyro_clipping
 * @return Reference to member gyro_clipping
 */
uint8_t& px4_msgs::msg::SensorCombined::gyro_clipping()
{
    return m_gyro_clipping;
}
