...
{
    // m_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@77659b30
    m_timestamp = 0;
    // m_position com.eprosima.idl.parser.typecode.AliasTypeCode@456d6c1e
    memset(&m_position, 0, (3) * 4);
    // m_yaw com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1e13529a
    m_yaw = 0.0;
    // m_delta com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1ec9bd38
    m_delta = 0.0;
