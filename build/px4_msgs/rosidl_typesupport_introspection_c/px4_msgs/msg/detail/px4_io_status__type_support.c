...
#include <stddef.h>
#include "px4_msgs/msg/detail/px4_io_status__rosidl_typesupport_introspection_c.h"
...
void Px4IoStatus__rosidl_typesupport_introspection_c__Px4IoStatus_init_function(
...
void Px4IoStatus__rosidl_typesupport_introspection_c__Px4IoStatus_fini_function(void * message_memory)
{
  px4_msgs__msg__Px4IoStatus__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember Px4IoStatus__rosidl_typesupport_introspection_c__Px4IoStatus_message_member_array[32] = {
  {
    "timestamp",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers Px4IoStatus__rosidl_typesupport_introspection_c__Px4IoStatus_message_members = {
  "px4_msgs__msg",  // message namespace
  "Px4IoStatus",  // message name
  32,  // number of fields
  sizeof(px4_msgs__msg__Px4IoStatus),
  Px4IoStatus__rosidl_typesupport_introspection_c__Px4IoStatus_message_member_array,  // message members
  Px4IoStatus__rosidl_typesupport_introspection_c__Px4IoStatus_init_function,  // function to initialize message memory (memory has to be allocated)
  Px4IoStatus__rosidl_typesupport_introspection_c__Px4IoStatus_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t Px4IoStatus__rosidl_typesupport_introspection_c__Px4IoStatus_message_type_support_handle = {
  0,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4_msgs, msg, Px4IoStatus)() {
  if (!Px4IoStatus__rosidl_typesupport_introspection_c__Px4IoStatus_message_type_support_handle.typesupport_identifier) {
    Px4IoStatus__rosidl_typesupport_introspection_c__Px4IoStatus_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &Px4IoStatus__rosidl_typesupport_introspection_c__Px4IoStatus_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
