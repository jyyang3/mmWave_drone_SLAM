...
size_t size_function__EstimatorOpticalFlowVel__gyro_rate(const void * untyped_member)
{
  (void)untyped_member;
  return 3;
}

const void * get_const_function__EstimatorOpticalFlowVel__gyro_rate(const void * untyped_member, size_t index)
{
  const auto & member =
...
void * get_function__EstimatorOpticalFlowVel__gyro_rate(void * untyped_member, size_t index)
{
  auto & member =
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember EstimatorOpticalFlowVel_message_member_array[8] = {
  {
    "timestamp",  // name
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(px4_msgs::msg::EstimatorOpticalFlowVel, gyro_rate),  // bytes offset in struct
    nullptr,  // default value
    size_function__EstimatorOpticalFlowVel__gyro_rate,  // size() function pointer
    get_const_function__EstimatorOpticalFlowVel__gyro_rate,  // get_const(index) function pointer
    get_function__EstimatorOpticalFlowVel__gyro_rate,  // get(index) function pointer
    nullptr  // resize(index) function pointer
  },
  {
