...
#ifndef PX4_MSGS__MSG__DETAIL__ESTIMATOR_OPTICAL_FLOW_VEL__STRUCT_HPP_
#define PX4_MSGS__MSG__DETAIL__ESTIMATOR_OPTICAL_FLOW_VEL__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__px4_msgs__msg__EstimatorOpticalFlowVel __attribute__((deprecated))
#else
# define DEPRECATED__px4_msgs__msg__EstimatorOpticalFlowVel __declspec(deprecated)
#endif
...
{
  using Type = EstimatorOpticalFlowVel_<ContainerAllocator>;

  explicit EstimatorOpticalFlowVel_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
  ...
  explicit EstimatorOpticalFlowVel_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : vel_body(_alloc),
    vel_ne(_alloc),
  ...
  // pointer types
  using RawPtr =
    px4_msgs::msg::EstimatorOpticalFlowVel_<ContainerAllocator> *;
  using ConstRawPtr =
    const px4_msgs::msg::EstimatorOpticalFlowVel_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<px4_msgs::msg::EstimatorOpticalFlowVel_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<px4_msgs::msg::EstimatorOpticalFlowVel_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      px4_msgs::msg::EstimatorOpticalFlowVel_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<px4_msgs::msg::EstimatorOpticalFlowVel_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<px4_msgs::msg::EstimatorOpticalFlowVel_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<px4_msgs::msg::EstimatorOpticalFlowVel_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<px4_msgs::msg::EstimatorOpticalFlowVel_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__px4_msgs__msg__EstimatorOpticalFlowVel
    std::shared_ptr<px4_msgs::msg::EstimatorOpticalFlowVel_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__px4_msgs__msg__EstimatorOpticalFlowVel
    std::shared_ptr<px4_msgs::msg::EstimatorOpticalFlowVel_<ContainerAllocator> const>
  ...
  bool operator==(const EstimatorOpticalFlowVel_ & other) const
  {
...
using EstimatorOpticalFlowVel =
  px4_msgs::msg::EstimatorOpticalFlowVel_<std::allocator<void>>;
...
#endif  // PX4_MSGS__MSG__DETAIL__ESTIMATOR_OPTICAL_FLOW_VEL__STRUCT_HPP_
