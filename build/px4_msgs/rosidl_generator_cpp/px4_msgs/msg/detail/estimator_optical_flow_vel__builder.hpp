...
class Init_EstimatorOpticalFlowVel_gyro_rate
{
public:
  explicit Init_EstimatorOpticalFlowVel_gyro_rate(::px4_msgs::msg::EstimatorOpticalFlowVel & msg)
  : msg_(msg)
  {}
  Init_EstimatorOpticalFlowVel_gyro_rate_integral gyro_rate(::px4_msgs::msg::EstimatorOpticalFlowVel::_gyro_rate_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_EstimatorOpticalFlowVel_gyro_rate flow_compensated_integral(::px4_msgs::msg::EstimatorOpticalFlowVel::_flow_compensated_integral_type arg)
  {
    msg_.flow_compensated_integral = std::move(arg);
    return Init_EstimatorOpticalFlowVel_gyro_rate(msg_);
  }
