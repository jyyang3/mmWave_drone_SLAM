...
class Init_VehicleAttitudeSetpoint_apply_spoilers
{
public:
  explicit Init_VehicleAttitudeSetpoint_apply_spoilers(::px4_msgs::msg::VehicleAttitudeSetpoint & msg)
  : msg_(msg)
  {}
  ::px4_msgs::msg::VehicleAttitudeSetpoint apply_spoilers(::px4_msgs::msg::VehicleAttitudeSetpoint::_apply_spoilers_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_VehicleAttitudeSetpoint_apply_spoilers apply_flaps(::px4_msgs::msg::VehicleAttitudeSetpoint::_apply_flaps_type arg)
  {
    msg_.apply_flaps = std::move(arg);
    return Init_VehicleAttitudeSetpoint_apply_spoilers(msg_);
  }
...
class Init_VehicleAttitudeSetpoint_reset_rate_integrals
{
public:
  explicit Init_VehicleAttitudeSetpoint_reset_rate_integrals(::px4_msgs::msg::VehicleAttitudeSetpoint & msg)
  : msg_(msg)
  {}
  Init_VehicleAttitudeSetpoint_fw_control_yaw reset_rate_integrals(::px4_msgs::msg::VehicleAttitudeSetpoint::_reset_rate_integrals_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_VehicleAttitudeSetpoint_reset_rate_integrals thrust_body(::px4_msgs::msg::VehicleAttitudeSetpoint::_thrust_body_type arg)
  {
    msg_.thrust_body = std::move(arg);
    return Init_VehicleAttitudeSetpoint_reset_rate_integrals(msg_);
  }
