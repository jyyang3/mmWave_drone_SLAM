...
class Init_EstimatorLocalPosition_dead_reckoning
{
public:
  explicit Init_EstimatorLocalPosition_dead_reckoning(::px4_msgs::msg::EstimatorLocalPosition & msg)
  : msg_(msg)
  {}
  Init_EstimatorLocalPosition_vxy_max dead_reckoning(::px4_msgs::msg::EstimatorLocalPosition::_dead_reckoning_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_EstimatorLocalPosition_dead_reckoning evv(::px4_msgs::msg::EstimatorLocalPosition::_evv_type arg)
  {
    msg_.evv = std::move(arg);
    return Init_EstimatorLocalPosition_dead_reckoning(msg_);
  }
