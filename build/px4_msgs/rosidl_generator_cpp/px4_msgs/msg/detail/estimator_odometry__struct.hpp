...
constexpr uint8_t EstimatorOdometry_<ContainerAllocator>::POSE_FRAME_UNKNOWN;
template<typename ContainerAllocator>
constexpr uint8_t EstimatorOdometry_<ContainerAllocator>::POSE_FRAME_NED;
template<typename ContainerAllocator>
constexpr uint8_t EstimatorOdometry_<ContainerAllocator>::POSE_FRAME_FRD;
template<typename ContainerAllocator>
constexpr uint8_t EstimatorOdometry_<ContainerAllocator>::VELOCITY_FRAME_UNKNOWN;
template<typename ContainerAllocator>
constexpr uint8_t EstimatorOdometry_<ContainerAllocator>::VELOCITY_FRAME_NED;
template<typename ContainerAllocator>
constexpr uint8_t EstimatorOdometry_<ContainerAllocator>::VELOCITY_FRAME_FRD;
template<typename ContainerAllocator>
constexpr uint8_t EstimatorOdometry_<ContainerAllocator>::VELOCITY_FRAME_BODY_FRD;
