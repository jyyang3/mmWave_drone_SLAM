...
class Init_EstimatorBias_baro_device_id
{
public:
  explicit Init_EstimatorBias_baro_device_id(::px4_msgs::msg::EstimatorBias & msg)
  : msg_(msg)
  {}
  Init_EstimatorBias_bias baro_device_id(::px4_msgs::msg::EstimatorBias::_baro_device_id_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_EstimatorBias_baro_device_id timestamp_sample(::px4_msgs::msg::EstimatorBias::_timestamp_sample_type arg)
  {
    msg_.timestamp_sample = std::move(arg);
    return Init_EstimatorBias_baro_device_id(msg_);
  }
