...
#ifndef PX4_MSGS__MSG__DETAIL__VEHICLE_VISUAL_ODOMETRY__STRUCT_HPP_
#define PX4_MSGS__MSG__DETAIL__VEHICLE_VISUAL_ODOMETRY__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__px4_msgs__msg__VehicleVisualOdometry __attribute__((deprecated))
#else
# define DEPRECATED__px4_msgs__msg__VehicleVisualOdometry __declspec(deprecated)
#endif
...
struct VehicleVisualOdometry_
{
  using Type = VehicleVisualOdometry_<ContainerAllocator>;

  explicit VehicleVisualOdometry_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
  ...
  explicit VehicleVisualOdometry_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : position(_alloc),
    q(_alloc),
    velocity(_alloc),
  ...
  // pointer types
  using RawPtr =
    px4_msgs::msg::VehicleVisualOdometry_<ContainerAllocator> *;
  using ConstRawPtr =
    const px4_msgs::msg::VehicleVisualOdometry_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<px4_msgs::msg::VehicleVisualOdometry_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<px4_msgs::msg::VehicleVisualOdometry_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      px4_msgs::msg::VehicleVisualOdometry_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<px4_msgs::msg::VehicleVisualOdometry_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<px4_msgs::msg::VehicleVisualOdometry_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<px4_msgs::msg::VehicleVisualOdometry_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<px4_msgs::msg::VehicleVisualOdometry_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__px4_msgs__msg__VehicleVisualOdometry
    std::shared_ptr<px4_msgs::msg::VehicleVisualOdometry_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__px4_msgs__msg__VehicleVisualOdometry
    std::shared_ptr<px4_msgs::msg::VehicleVisualOdometry_<ContainerAllocator> const>
  ...
  bool operator==(const VehicleVisualOdometry_ & other) const
  {
...
using VehicleVisualOdometry =
  px4_msgs::msg::VehicleVisualOdometry_<std::allocator<void>>;

// constant definitions
template<typename ContainerAllocator>
constexpr uint8_t VehicleVisualOdometry_<ContainerAllocator>::POSE_FRAME_UNKNOWN;
template<typename ContainerAllocator>
constexpr uint8_t VehicleVisualOdometry_<ContainerAllocator>::POSE_FRAME_NED;
template<typename ContainerAllocator>
constexpr uint8_t VehicleVisualOdometry_<ContainerAllocator>::POSE_FRAME_FRD;
template<typename ContainerAllocator>
constexpr uint8_t VehicleVisualOdometry_<ContainerAllocator>::VELOCITY_FRAME_UNKNOWN;
template<typename ContainerAllocator>
constexpr uint8_t VehicleVisualOdometry_<ContainerAllocator>::VELOCITY_FRAME_NED;
template<typename ContainerAllocator>
constexpr uint8_t VehicleVisualOdometry_<ContainerAllocator>::VELOCITY_FRAME_FRD;
template<typename ContainerAllocator>
constexpr uint8_t VehicleVisualOdometry_<ContainerAllocator>::VELOCITY_FRAME_BODY_FRD;

}  // namespace msg

}  // namespace px4_msgs

#endif  // PX4_MSGS__MSG__DETAIL__VEHICLE_VISUAL_ODOMETRY__STRUCT_HPP_
