...
#ifndef PX4_MSGS__MSG__DETAIL__VEHICLE_LOCAL_POSITION_GROUNDTRUTH__STRUCT_HPP_
#define PX4_MSGS__MSG__DETAIL__VEHICLE_LOCAL_POSITION_GROUNDTRUTH__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__px4_msgs__msg__VehicleLocalPositionGroundtruth __attribute__((deprecated))
#else
# define DEPRECATED__px4_msgs__msg__VehicleLocalPositionGroundtruth __declspec(deprecated)
#endif
...
{
  using Type = VehicleLocalPositionGroundtruth_<ContainerAllocator>;

  explicit VehicleLocalPositionGroundtruth_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
  ...
  explicit VehicleLocalPositionGroundtruth_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : delta_xy(_alloc),
    delta_vxy(_alloc)
  {
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
  ...
  // pointer types
  using RawPtr =
    px4_msgs::msg::VehicleLocalPositionGroundtruth_<ContainerAllocator> *;
  using ConstRawPtr =
    const px4_msgs::msg::VehicleLocalPositionGroundtruth_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<px4_msgs::msg::VehicleLocalPositionGroundtruth_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<px4_msgs::msg::VehicleLocalPositionGroundtruth_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      px4_msgs::msg::VehicleLocalPositionGroundtruth_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<px4_msgs::msg::VehicleLocalPositionGroundtruth_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<px4_msgs::msg::VehicleLocalPositionGroundtruth_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<px4_msgs::msg::VehicleLocalPositionGroundtruth_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<px4_msgs::msg::VehicleLocalPositionGroundtruth_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__px4_msgs__msg__VehicleLocalPositionGroundtruth
    std::shared_ptr<px4_msgs::msg::VehicleLocalPositionGroundtruth_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__px4_msgs__msg__VehicleLocalPositionGroundtruth
    std::shared_ptr<px4_msgs::msg::VehicleLocalPositionGroundtruth_<ContainerAllocator> const>
  ...
  bool operator==(const VehicleLocalPositionGroundtruth_ & other) const
  {
...
using VehicleLocalPositionGroundtruth =
  px4_msgs::msg::VehicleLocalPositionGroundtruth_<std::allocator<void>>;

// constant definitions
template<typename ContainerAllocator>
constexpr uint8_t VehicleLocalPositionGroundtruth_<ContainerAllocator>::DIST_BOTTOM_SENSOR_NONE;
template<typename ContainerAllocator>
constexpr uint8_t VehicleLocalPositionGroundtruth_<ContainerAllocator>::DIST_BOTTOM_SENSOR_RANGE;
template<typename ContainerAllocator>
constexpr uint8_t VehicleLocalPositionGroundtruth_<ContainerAllocator>::DIST_BOTTOM_SENSOR_FLOW;

}  // namespace msg

}  // namespace px4_msgs

#endif  // PX4_MSGS__MSG__DETAIL__VEHICLE_LOCAL_POSITION_GROUNDTRUTH__STRUCT_HPP_
