...
px4_msgs__msg__EstimatorAidSrcBaroHgt__create()
{
  ...
  px4_msgs__msg__EstimatorAidSrcBaroHgt * msg = (px4_msgs__msg__EstimatorAidSrcBaroHgt *)allocator.allocate(sizeof(px4_msgs__msg__EstimatorAidSrcBaroHgt), allocator.state);
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__EstimatorAidSrcBaroHgt__Sequence__init(px4_msgs__msg__EstimatorAidSrcBaroHgt__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__EstimatorAidSrcBaroHgt *)allocator.zero_allocate(size, sizeof(px4_msgs__msg__EstimatorAidSrcBaroHgt), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  px4_msgs__msg__EstimatorAidSrcBaroHgt__Sequence * array = (px4_msgs__msg__EstimatorAidSrcBaroHgt__Sequence *)allocator.allocate(sizeof(px4_msgs__msg__EstimatorAidSrcBaroHgt__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
px4_msgs__msg__EstimatorAidSrcBaroHgt__Sequence__are_equal(const px4_msgs__msg__EstimatorAidSrcBaroHgt__Sequence * lhs, const px4_msgs__msg__EstimatorAidSrcBaroHgt__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!px4_msgs__msg__EstimatorAidSrcBaroHgt__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  px4_msgs__msg__EstimatorAidSrcBaroHgt__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(px4_msgs__msg__EstimatorAidSrcBaroHgt);
    px4_msgs__msg__EstimatorAidSrcBaroHgt * data =
      (px4_msgs__msg__EstimatorAidSrcBaroHgt *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!px4_msgs__msg__EstimatorAidSrcBaroHgt__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          px4_msgs__msg__EstimatorAidSrcBaroHgt__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!px4_msgs__msg__EstimatorAidSrcBaroHgt__copy(
