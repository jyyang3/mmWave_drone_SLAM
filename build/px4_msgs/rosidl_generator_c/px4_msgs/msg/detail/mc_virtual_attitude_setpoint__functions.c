...
px4_msgs__msg__McVirtualAttitudeSetpoint__are_equal(const px4_msgs__msg__McVirtualAttitudeSetpoint * lhs, const px4_msgs__msg__McVirtualAttitudeSetpoint * rhs)
{
  ...
  // reset_rate_integrals
  if (lhs->reset_rate_integrals != rhs->reset_rate_integrals) {
    return false;
  }
  // fw_control_yaw
  ...
  // apply_spoilers
  if (lhs->apply_spoilers != rhs->apply_spoilers) {
    return false;
  }
  return true;
}
  ...
  px4_msgs__msg__McVirtualAttitudeSetpoint * output)
{
  ...
  // reset_rate_integrals
  output->reset_rate_integrals = input->reset_rate_integrals;
  // fw_control_yaw
  output->fw_control_yaw = input->fw_control_yaw;
  // apply_flaps
  output->apply_flaps = input->apply_flaps;
  // apply_spoilers
  output->apply_spoilers = input->apply_spoilers;
  return true;
}
...
px4_msgs__msg__McVirtualAttitudeSetpoint__create()
{
  ...
  px4_msgs__msg__McVirtualAttitudeSetpoint * msg = (px4_msgs__msg__McVirtualAttitudeSetpoint *)allocator.allocate(sizeof(px4_msgs__msg__McVirtualAttitudeSetpoint), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(px4_msgs__msg__McVirtualAttitudeSetpoint));
  bool success = px4_msgs__msg__McVirtualAttitudeSetpoint__init(msg);
  if (!success) {
...
px4_msgs__msg__McVirtualAttitudeSetpoint__destroy(px4_msgs__msg__McVirtualAttitudeSetpoint * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    px4_msgs__msg__McVirtualAttitudeSetpoint__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
px4_msgs__msg__McVirtualAttitudeSetpoint__Sequence__init(px4_msgs__msg__McVirtualAttitudeSetpoint__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  px4_msgs__msg__McVirtualAttitudeSetpoint * data = NULL;

  if (size) {
    data = (px4_msgs__msg__McVirtualAttitudeSetpoint *)allocator.zero_allocate(size, sizeof(px4_msgs__msg__McVirtualAttitudeSetpoint), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = px4_msgs__msg__McVirtualAttitudeSetpoint__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        px4_msgs__msg__McVirtualAttitudeSetpoint__fini(&data[i - 1]);
      }
...
px4_msgs__msg__McVirtualAttitudeSetpoint__Sequence__fini(px4_msgs__msg__McVirtualAttitudeSetpoint__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      px4_msgs__msg__McVirtualAttitudeSetpoint__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  px4_msgs__msg__McVirtualAttitudeSetpoint__Sequence * array = (px4_msgs__msg__McVirtualAttitudeSetpoint__Sequence *)allocator.allocate(sizeof(px4_msgs__msg__McVirtualAttitudeSetpoint__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = px4_msgs__msg__McVirtualAttitudeSetpoint__Sequence__init(array, size);
  if (!success) {
...
px4_msgs__msg__McVirtualAttitudeSetpoint__Sequence__destroy(px4_msgs__msg__McVirtualAttitudeSetpoint__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    px4_msgs__msg__McVirtualAttitudeSetpoint__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
px4_msgs__msg__McVirtualAttitudeSetpoint__Sequence__are_equal(const px4_msgs__msg__McVirtualAttitudeSetpoint__Sequence * lhs, const px4_msgs__msg__McVirtualAttitudeSetpoint__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!px4_msgs__msg__McVirtualAttitudeSetpoint__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  px4_msgs__msg__McVirtualAttitudeSetpoint__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(px4_msgs__msg__McVirtualAttitudeSetpoint);
    px4_msgs__msg__McVirtualAttitudeSetpoint * data =
      (px4_msgs__msg__McVirtualAttitudeSetpoint *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!px4_msgs__msg__McVirtualAttitudeSetpoint__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          px4_msgs__msg__McVirtualAttitudeSetpoint__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!px4_msgs__msg__McVirtualAttitudeSetpoint__copy(
