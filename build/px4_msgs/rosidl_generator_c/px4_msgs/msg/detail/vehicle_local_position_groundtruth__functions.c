...
bool
px4_msgs__msg__VehicleLocalPositionGroundtruth__are_equal(const px4_msgs__msg__VehicleLocalPositionGroundtruth * lhs, const px4_msgs__msg__VehicleLocalPositionGroundtruth * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
px4_msgs__msg__VehicleLocalPositionGroundtruth__copy(
  const px4_msgs__msg__VehicleLocalPositionGroundtruth * input,
  px4_msgs__msg__VehicleLocalPositionGroundtruth * output)
{
  if (!input || !output) {
    return false;
  }
...
px4_msgs__msg__VehicleLocalPositionGroundtruth__create()
{
  ...
  px4_msgs__msg__VehicleLocalPositionGroundtruth * msg = (px4_msgs__msg__VehicleLocalPositionGroundtruth *)allocator.allocate(sizeof(px4_msgs__msg__VehicleLocalPositionGroundtruth), allocator.state);
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__VehicleLocalPositionGroundtruth__Sequence__init(px4_msgs__msg__VehicleLocalPositionGroundtruth__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__VehicleLocalPositionGroundtruth *)allocator.zero_allocate(size, sizeof(px4_msgs__msg__VehicleLocalPositionGroundtruth), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  px4_msgs__msg__VehicleLocalPositionGroundtruth__Sequence * array = (px4_msgs__msg__VehicleLocalPositionGroundtruth__Sequence *)allocator.allocate(sizeof(px4_msgs__msg__VehicleLocalPositionGroundtruth__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
px4_msgs__msg__VehicleLocalPositionGroundtruth__Sequence__are_equal(const px4_msgs__msg__VehicleLocalPositionGroundtruth__Sequence * lhs, const px4_msgs__msg__VehicleLocalPositionGroundtruth__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!px4_msgs__msg__VehicleLocalPositionGroundtruth__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
px4_msgs__msg__VehicleLocalPositionGroundtruth__Sequence__copy(
  const px4_msgs__msg__VehicleLocalPositionGroundtruth__Sequence * input,
  px4_msgs__msg__VehicleLocalPositionGroundtruth__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(px4_msgs__msg__VehicleLocalPositionGroundtruth);
    px4_msgs__msg__VehicleLocalPositionGroundtruth * data =
      (px4_msgs__msg__VehicleLocalPositionGroundtruth *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!px4_msgs__msg__VehicleLocalPositionGroundtruth__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          px4_msgs__msg__VehicleLocalPositionGroundtruth__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!px4_msgs__msg__VehicleLocalPositionGroundtruth__copy(
