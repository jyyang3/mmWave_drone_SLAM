...
enum
{
  px4_msgs__msg__VehicleVisualOdometry__POSE_FRAME_UNKNOWN = 0
};

/// Constant 'POSE_FRAME_NED'.
enum
{
  px4_msgs__msg__VehicleVisualOdometry__POSE_FRAME_NED = 1
};

/// Constant 'POSE_FRAME_FRD'.
enum
{
  px4_msgs__msg__VehicleVisualOdometry__POSE_FRAME_FRD = 2
};

/// Constant 'VELOCITY_FRAME_UNKNOWN'.
enum
{
  px4_msgs__msg__VehicleVisualOdometry__VELOCITY_FRAME_UNKNOWN = 0
};

/// Constant 'VELOCITY_FRAME_NED'.
enum
{
  px4_msgs__msg__VehicleVisualOdometry__VELOCITY_FRAME_NED = 1
};

/// Constant 'VELOCITY_FRAME_FRD'.
enum
{
  px4_msgs__msg__VehicleVisualOdometry__VELOCITY_FRAME_FRD = 2
};

/// Constant 'VELOCITY_FRAME_BODY_FRD'.
enum
{
  px4_msgs__msg__VehicleVisualOdometry__VELOCITY_FRAME_BODY_FRD = 3
};
