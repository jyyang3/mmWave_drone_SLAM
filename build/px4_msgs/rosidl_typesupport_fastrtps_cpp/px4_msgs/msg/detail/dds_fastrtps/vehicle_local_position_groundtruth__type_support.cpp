...
#include "px4_msgs/msg/detail/vehicle_local_position_groundtruth__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4_msgs::msg::VehicleLocalPositionGroundtruth & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4_msgs::msg::VehicleLocalPositionGroundtruth & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_px4_msgs
max_serialized_size_VehicleLocalPositionGroundtruth(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const px4_msgs::msg::VehicleLocalPositionGroundtruth *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4_msgs::msg::VehicleLocalPositionGroundtruth *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _VehicleLocalPositionGroundtruth__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const px4_msgs::msg::VehicleLocalPositionGroundtruth *>(
...
{
  return max_serialized_size_VehicleLocalPositionGroundtruth(full_bounded, 0);
}

static message_type_support_callbacks_t _VehicleLocalPositionGroundtruth__callbacks = {
  "px4_msgs::msg",
...
static rosidl_message_type_support_t _VehicleLocalPositionGroundtruth__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_VehicleLocalPositionGroundtruth__callbacks,
...
{
  return &px4_msgs::msg::typesupport_fastrtps_cpp::_VehicleLocalPositionGroundtruth__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4_msgs, msg, VehicleLocalPositionGroundtruth)() {
  return &px4_msgs::msg::typesupport_fastrtps_cpp::_VehicleLocalPositionGroundtruth__handle;
}
