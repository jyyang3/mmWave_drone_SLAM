...
#include "px4_msgs/msg/detail/estimator_visual_odometry_aligned__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4_msgs::msg::EstimatorVisualOdometryAligned & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4_msgs::msg::EstimatorVisualOdometryAligned & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_px4_msgs
max_serialized_size_EstimatorVisualOdometryAligned(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const px4_msgs::msg::EstimatorVisualOdometryAligned *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4_msgs::msg::EstimatorVisualOdometryAligned *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _EstimatorVisualOdometryAligned__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const px4_msgs::msg::EstimatorVisualOdometryAligned *>(
...
{
  return max_serialized_size_EstimatorVisualOdometryAligned(full_bounded, 0);
}

static message_type_support_callbacks_t _EstimatorVisualOdometryAligned__callbacks = {
  "px4_msgs::msg",
...
static rosidl_message_type_support_t _EstimatorVisualOdometryAligned__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_EstimatorVisualOdometryAligned__callbacks,
...
{
  return &px4_msgs::msg::typesupport_fastrtps_cpp::_EstimatorVisualOdometryAligned__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4_msgs, msg, EstimatorVisualOdometryAligned)() {
  return &px4_msgs::msg::typesupport_fastrtps_cpp::_EstimatorVisualOdometryAligned__handle;
}
