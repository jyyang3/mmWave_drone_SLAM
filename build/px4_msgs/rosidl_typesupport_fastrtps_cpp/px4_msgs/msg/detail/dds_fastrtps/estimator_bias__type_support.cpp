...
#include "px4_msgs/msg/detail/estimator_bias__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4_msgs::msg::EstimatorBias & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4_msgs::msg::EstimatorBias & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
...
{
  auto typed_message =
    static_cast<const px4_msgs::msg::EstimatorBias *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4_msgs::msg::EstimatorBias *>(
    untyped_ros_message);
...
{
  return max_serialized_size_EstimatorBias(full_bounded, 0);
}
...
{
  return &px4_msgs::msg::typesupport_fastrtps_cpp::_EstimatorBias__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4_msgs, msg, EstimatorBias)() {
  return &px4_msgs::msg::typesupport_fastrtps_cpp::_EstimatorBias__handle;
}
