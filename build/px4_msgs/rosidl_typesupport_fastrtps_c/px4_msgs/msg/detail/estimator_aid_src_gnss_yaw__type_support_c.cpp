...
#include "px4_msgs/msg/detail/estimator_aid_src_gnss_yaw__rosidl_typesupport_fastrtps_c.h"
...
using _EstimatorAidSrcGnssYaw__ros_msg_type = px4_msgs__msg__EstimatorAidSrcGnssYaw;

static bool _EstimatorAidSrcGnssYaw__cdr_serialize(
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _EstimatorAidSrcGnssYaw__ros_msg_type * ros_message = static_cast<const _EstimatorAidSrcGnssYaw__ros_msg_type *>(untyped_ros_message);
...
static bool _EstimatorAidSrcGnssYaw__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _EstimatorAidSrcGnssYaw__ros_msg_type * ros_message = static_cast<_EstimatorAidSrcGnssYaw__ros_msg_type *>(untyped_ros_message);
  // Field name: timestamp
  {
    cdr >> ros_message->timestamp;
  }
...
size_t get_serialized_size_px4_msgs__msg__EstimatorAidSrcGnssYaw(
  const void * untyped_ros_message,
...
static uint32_t _EstimatorAidSrcGnssYaw__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4_msgs__msg__EstimatorAidSrcGnssYaw(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4_msgs
size_t max_serialized_size_px4_msgs__msg__EstimatorAidSrcGnssYaw(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
static size_t _EstimatorAidSrcGnssYaw__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_px4_msgs__msg__EstimatorAidSrcGnssYaw(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_EstimatorAidSrcGnssYaw = {
  "px4_msgs::msg",
  "EstimatorAidSrcGnssYaw",
  _EstimatorAidSrcGnssYaw__cdr_serialize,
  _EstimatorAidSrcGnssYaw__cdr_deserialize,
  _EstimatorAidSrcGnssYaw__get_serialized_size,
  _EstimatorAidSrcGnssYaw__max_serialized_size
};

static rosidl_message_type_support_t _EstimatorAidSrcGnssYaw__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_EstimatorAidSrcGnssYaw,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4_msgs, msg, EstimatorAidSrcGnssYaw)() {
  return &_EstimatorAidSrcGnssYaw__type_support;
}
