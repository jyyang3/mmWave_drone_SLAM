...
#include "px4_msgs/msg/detail/estimator_aid_src_fake_hgt__rosidl_typesupport_fastrtps_c.h"
...
using _EstimatorAidSrcFakeHgt__ros_msg_type = px4_msgs__msg__EstimatorAidSrcFakeHgt;

static bool _EstimatorAidSrcFakeHgt__cdr_serialize(
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _EstimatorAidSrcFakeHgt__ros_msg_type * ros_message = static_cast<const _EstimatorAidSrcFakeHgt__ros_msg_type *>(untyped_ros_message);
...
static bool _EstimatorAidSrcFakeHgt__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _EstimatorAidSrcFakeHgt__ros_msg_type * ros_message = static_cast<_EstimatorAidSrcFakeHgt__ros_msg_type *>(untyped_ros_message);
  // Field name: timestamp
  {
    cdr >> ros_message->timestamp;
  }
...
size_t get_serialized_size_px4_msgs__msg__EstimatorAidSrcFakeHgt(
  const void * untyped_ros_message,
...
static uint32_t _EstimatorAidSrcFakeHgt__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4_msgs__msg__EstimatorAidSrcFakeHgt(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4_msgs
size_t max_serialized_size_px4_msgs__msg__EstimatorAidSrcFakeHgt(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
static size_t _EstimatorAidSrcFakeHgt__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_px4_msgs__msg__EstimatorAidSrcFakeHgt(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_EstimatorAidSrcFakeHgt = {
  "px4_msgs::msg",
  "EstimatorAidSrcFakeHgt",
  _EstimatorAidSrcFakeHgt__cdr_serialize,
  _EstimatorAidSrcFakeHgt__cdr_deserialize,
  _EstimatorAidSrcFakeHgt__get_serialized_size,
  _EstimatorAidSrcFakeHgt__max_serialized_size
};

static rosidl_message_type_support_t _EstimatorAidSrcFakeHgt__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_EstimatorAidSrcFakeHgt,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4_msgs, msg, EstimatorAidSrcFakeHgt)() {
  return &_EstimatorAidSrcFakeHgt__type_support;
}
