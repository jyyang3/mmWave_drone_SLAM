...
#include "px4_msgs/msg/detail/vehicle_local_position_groundtruth__rosidl_typesupport_fastrtps_c.h"
...
using _VehicleLocalPositionGroundtruth__ros_msg_type = px4_msgs__msg__VehicleLocalPositionGroundtruth;

static bool _VehicleLocalPositionGroundtruth__cdr_serialize(
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _VehicleLocalPositionGroundtruth__ros_msg_type * ros_message = static_cast<const _VehicleLocalPositionGroundtruth__ros_msg_type *>(untyped_ros_message);
...
static bool _VehicleLocalPositionGroundtruth__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _VehicleLocalPositionGroundtruth__ros_msg_type * ros_message = static_cast<_VehicleLocalPositionGroundtruth__ros_msg_type *>(untyped_ros_message);
  // Field name: timestamp
  {
    cdr >> ros_message->timestamp;
  }
...
static uint32_t _VehicleLocalPositionGroundtruth__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4_msgs__msg__VehicleLocalPositionGroundtruth(
...
static size_t _VehicleLocalPositionGroundtruth__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_px4_msgs__msg__VehicleLocalPositionGroundtruth(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_VehicleLocalPositionGroundtruth = {
  "px4_msgs::msg",
  "VehicleLocalPositionGroundtruth",
  _VehicleLocalPositionGroundtruth__cdr_serialize,
  _VehicleLocalPositionGroundtruth__cdr_deserialize,
  _VehicleLocalPositionGroundtruth__get_serialized_size,
  _VehicleLocalPositionGroundtruth__max_serialized_size
};

static rosidl_message_type_support_t _VehicleLocalPositionGroundtruth__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_VehicleLocalPositionGroundtruth,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4_msgs, msg, VehicleLocalPositionGroundtruth)() {
  return &_VehicleLocalPositionGroundtruth__type_support;
}
