...
#include "px4_msgs/msg/detail/mc_virtual_attitude_setpoint__rosidl_typesupport_fastrtps_c.h"
...
using _McVirtualAttitudeSetpoint__ros_msg_type = px4_msgs__msg__McVirtualAttitudeSetpoint;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _McVirtualAttitudeSetpoint__ros_msg_type * ros_message = static_cast<const _McVirtualAttitudeSetpoint__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _McVirtualAttitudeSetpoint__ros_msg_type * ros_message = static_cast<_McVirtualAttitudeSetpoint__ros_msg_type *>(untyped_ros_message);
  // Field name: timestamp
  {
    cdr >> ros_message->timestamp;
  }
...
size_t get_serialized_size_px4_msgs__msg__McVirtualAttitudeSetpoint(
  const void * untyped_ros_message,
...
static uint32_t _McVirtualAttitudeSetpoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4_msgs__msg__McVirtualAttitudeSetpoint(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4_msgs
size_t max_serialized_size_px4_msgs__msg__McVirtualAttitudeSetpoint(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_px4_msgs__msg__McVirtualAttitudeSetpoint(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_McVirtualAttitudeSetpoint = {
  "px4_msgs::msg",
...
static rosidl_message_type_support_t _McVirtualAttitudeSetpoint__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_McVirtualAttitudeSetpoint,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4_msgs, msg, McVirtualAttitudeSetpoint)() {
  return &_McVirtualAttitudeSetpoint__type_support;
}
