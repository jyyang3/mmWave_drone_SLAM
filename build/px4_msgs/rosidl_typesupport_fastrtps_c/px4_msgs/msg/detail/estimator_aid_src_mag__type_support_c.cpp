...
#include "px4_msgs/msg/detail/estimator_aid_src_mag__rosidl_typesupport_fastrtps_c.h"
...
using _EstimatorAidSrcMag__ros_msg_type = px4_msgs__msg__EstimatorAidSrcMag;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _EstimatorAidSrcMag__ros_msg_type * ros_message = static_cast<const _EstimatorAidSrcMag__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _EstimatorAidSrcMag__ros_msg_type * ros_message = static_cast<_EstimatorAidSrcMag__ros_msg_type *>(untyped_ros_message);
  // Field name: timestamp
  {
    cdr >> ros_message->timestamp;
  }
...
size_t get_serialized_size_px4_msgs__msg__EstimatorAidSrcMag(
  const void * untyped_ros_message,
...
static uint32_t _EstimatorAidSrcMag__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4_msgs__msg__EstimatorAidSrcMag(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4_msgs
size_t max_serialized_size_px4_msgs__msg__EstimatorAidSrcMag(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_px4_msgs__msg__EstimatorAidSrcMag(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_EstimatorAidSrcMag = {
  "px4_msgs::msg",
  "EstimatorAidSrcMag",
...
static rosidl_message_type_support_t _EstimatorAidSrcMag__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_EstimatorAidSrcMag,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4_msgs, msg, EstimatorAidSrcMag)() {
  return &_EstimatorAidSrcMag__type_support;
}
