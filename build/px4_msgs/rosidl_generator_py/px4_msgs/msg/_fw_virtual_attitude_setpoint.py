...
class Metaclass_FwVirtualAttitudeSetpoint(type):
    """Metaclass of message 'FwVirtualAttitudeSetpoint'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__fw_virtual_attitude_setpoint
            ...
            cls._TYPE_SUPPORT = module.type_support_msg__msg__fw_virtual_attitude_setpoint
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__fw_virtual_attitude_setpoint
    ...
    def FLAPS_OFF(self):
        ...
        return Metaclass_FwVirtualAttitudeSetpoint.__constants['FLAPS_OFF']

    @property
    def FLAPS_LAND(self):
        """Message constant 'FLAPS_LAND'."""
        return Metaclass_FwVirtualAttitudeSetpoint.__constants['FLAPS_LAND']

    @property
    def FLAPS_TAKEOFF(self):
        """Message constant 'FLAPS_TAKEOFF'."""
        return Metaclass_FwVirtualAttitudeSetpoint.__constants['FLAPS_TAKEOFF']

    @property
    def SPOILERS_OFF(self):
        """Message constant 'SPOILERS_OFF'."""
        return Metaclass_FwVirtualAttitudeSetpoint.__constants['SPOILERS_OFF']

    @property
    def SPOILERS_LAND(self):
        """Message constant 'SPOILERS_LAND'."""
        return Metaclass_FwVirtualAttitudeSetpoint.__constants['SPOILERS_LAND']

    @property
    def SPOILERS_DESCEND(self):
        """Message constant 'SPOILERS_DESCEND'."""
        return Metaclass_FwVirtualAttitudeSetpoint.__constants['SPOILERS_DESCEND']


class FwVirtualAttitudeSetpoint(metaclass=Metaclass_FwVirtualAttitudeSetpoint):
    """
    Message class 'FwVirtualAttitudeSetpoint'.
