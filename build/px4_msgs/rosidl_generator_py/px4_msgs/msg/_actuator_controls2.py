...
class Metaclass_ActuatorControls2(type):
    """Metaclass of message 'ActuatorControls2'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'px4_msgs.msg.ActuatorControls2')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__actuator_controls2
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__actuator_controls2
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__actuator_controls2
            cls._TYPE_SUPPORT = module.type_support_msg__msg__actuator_controls2
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__actuator_controls2
    ...
    def NUM_ACTUATOR_CONTROLS(self):
        ...
        return Metaclass_ActuatorControls2.__constants['NUM_ACTUATOR_CONTROLS']

    @property
    def NUM_ACTUATOR_CONTROL_GROUPS(self):
        """Message constant 'NUM_ACTUATOR_CONTROL_GROUPS'."""
        return Metaclass_ActuatorControls2.__constants['NUM_ACTUATOR_CONTROL_GROUPS']

    @property
    def INDEX_ROLL(self):
        """Message constant 'INDEX_ROLL'."""
        return Metaclass_ActuatorControls2.__constants['INDEX_ROLL']

    @property
    def INDEX_PITCH(self):
        """Message constant 'INDEX_PITCH'."""
        return Metaclass_ActuatorControls2.__constants['INDEX_PITCH']

    @property
    def INDEX_YAW(self):
        """Message constant 'INDEX_YAW'."""
        return Metaclass_ActuatorControls2.__constants['INDEX_YAW']

    @property
    def INDEX_THROTTLE(self):
        """Message constant 'INDEX_THROTTLE'."""
        return Metaclass_ActuatorControls2.__constants['INDEX_THROTTLE']

    @property
    def INDEX_FLAPS(self):
        """Message constant 'INDEX_FLAPS'."""
        return Metaclass_ActuatorControls2.__constants['INDEX_FLAPS']

    @property
    def INDEX_SPOILERS(self):
        """Message constant 'INDEX_SPOILERS'."""
        return Metaclass_ActuatorControls2.__constants['INDEX_SPOILERS']

    @property
    def INDEX_AIRBRAKES(self):
        """Message constant 'INDEX_AIRBRAKES'."""
        return Metaclass_ActuatorControls2.__constants['INDEX_AIRBRAKES']

    @property
    def INDEX_LANDING_GEAR(self):
        """Message constant 'INDEX_LANDING_GEAR'."""
        return Metaclass_ActuatorControls2.__constants['INDEX_LANDING_GEAR']

    @property
    def INDEX_GIMBAL_SHUTTER(self):
        """Message constant 'INDEX_GIMBAL_SHUTTER'."""
        return Metaclass_ActuatorControls2.__constants['INDEX_GIMBAL_SHUTTER']

    @property
    def INDEX_CAMERA_ZOOM(self):
        """Message constant 'INDEX_CAMERA_ZOOM'."""
        return Metaclass_ActuatorControls2.__constants['INDEX_CAMERA_ZOOM']

    @property
    def INDEX_COLLECTIVE_TILT(self):
        """Message constant 'INDEX_COLLECTIVE_TILT'."""
        return Metaclass_ActuatorControls2.__constants['INDEX_COLLECTIVE_TILT']

    @property
    def GROUP_INDEX_ATTITUDE(self):
        """Message constant 'GROUP_INDEX_ATTITUDE'."""
        return Metaclass_ActuatorControls2.__constants['GROUP_INDEX_ATTITUDE']

    @property
    def GROUP_INDEX_ATTITUDE_ALTERNATE(self):
        """Message constant 'GROUP_INDEX_ATTITUDE_ALTERNATE'."""
        return Metaclass_ActuatorControls2.__constants['GROUP_INDEX_ATTITUDE_ALTERNATE']

    @property
    def GROUP_INDEX_GIMBAL(self):
        """Message constant 'GROUP_INDEX_GIMBAL'."""
        return Metaclass_ActuatorControls2.__constants['GROUP_INDEX_GIMBAL']


class ActuatorControls2(metaclass=Metaclass_ActuatorControls2):
    """
    Message class 'ActuatorControls2'.
