...
bool px4_msgs__msg__fw_virtual_attitude_setpoint__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._fw_virtual_attitude_setpoint.FwVirtualAttitudeSetpoint", full_classname_dest, 68) == 0);
  }
  px4_msgs__msg__FwVirtualAttitudeSetpoint * ros_message = _ros_message;
  {  // timestamp
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4_msgs__msg__fw_virtual_attitude_setpoint__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of FwVirtualAttitudeSetpoint */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._fw_virtual_attitude_setpoint");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FwVirtualAttitudeSetpoint");
  ...
  px4_msgs__msg__FwVirtualAttitudeSetpoint * ros_message = (px4_msgs__msg__FwVirtualAttitudeSetpoint *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
