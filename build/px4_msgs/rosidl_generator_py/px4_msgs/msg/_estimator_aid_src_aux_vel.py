...
class Metaclass_EstimatorAidSrcAuxVel(type):
    """Metaclass of message 'EstimatorAidSrcAuxVel'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'px4_msgs.msg.EstimatorAidSrcAuxVel')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__estimator_aid_src_aux_vel
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__estimator_aid_src_aux_vel
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__estimator_aid_src_aux_vel
            cls._TYPE_SUPPORT = module.type_support_msg__msg__estimator_aid_src_aux_vel
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__estimator_aid_src_aux_vel
...
class EstimatorAidSrcAuxVel(metaclass=Metaclass_EstimatorAidSrcAuxVel):
    """Message class 'EstimatorAidSrcAuxVel'."""
    ...
    _fields_and_field_types = {
        ...
        'device_id': 'uint32',
        'time_last_fuse': 'uint64[3]',
        'observation': 'float[3]',
        'observation_variance': 'float[3]',
        'innovation': 'float[3]',
        'innovation_variance': 'float[3]',
        'test_ratio': 'float[3]',
        'fusion_enabled': 'boolean[3]',
        'innovation_rejected': 'boolean[3]',
        'fused': 'boolean[3]',
    }
    ...
    def __init__(self, **kwargs):
        ...
        if 'time_last_fuse' not in kwargs:
            self.time_last_fuse = numpy.zeros(3, dtype=numpy.uint64)
        else:
            self.time_last_fuse = numpy.array(kwargs.get('time_last_fuse'), dtype=numpy.uint64)
            assert self.time_last_fuse.shape == (3, )
        ...
        self.fusion_enabled = kwargs.get(
            'fusion_enabled',
            [bool() for x in range(3)]
        )
        self.innovation_rejected = kwargs.get(
            'innovation_rejected',
            [bool() for x in range(3)]
        )
        self.fused = kwargs.get(
            'fused',
            [bool() for x in range(3)]
        )
    ...
    def __eq__(self, other):
        ...
        if self.device_id != other.device_id:
            return False
        if all(self.time_last_fuse != other.time_last_fuse):
            return False
    ...
    def time_last_fuse(self, value):
        if isinstance(value, numpy.ndarray):
            assert value.dtype == numpy.uint64, \
                "The 'time_last_fuse' numpy.ndarray() must have the dtype of 'numpy.uint64'"
            assert value.size == 3, \
                "The 'time_last_fuse' numpy.ndarray() must have a size of 3"
        ...
        if __debug__:
            ...
            assert \
                ...
                "The 'time_last_fuse' field must be a set or sequence with length 3 and each value of type 'int' and each unsigned integer in [0, 18446744073709551615]"
        self._time_last_fuse = numpy.array(value, dtype=numpy.uint64)
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'fusion_enabled' field must be a set or sequence with length 3 and each value of type 'bool'"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, bool) for v in value) and
                 True), \
                "The 'innovation_rejected' field must be a set or sequence with length 3 and each value of type 'bool'"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, bool) for v in value) and
                 True), \
                "The 'fused' field must be a set or sequence with length 3 and each value of type 'bool'"
        self._fused = value
