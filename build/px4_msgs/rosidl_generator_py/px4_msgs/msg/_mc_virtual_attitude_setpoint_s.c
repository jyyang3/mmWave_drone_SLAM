...
bool px4_msgs__msg__mc_virtual_attitude_setpoint__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._mc_virtual_attitude_setpoint.McVirtualAttitudeSetpoint", full_classname_dest, 68) == 0);
  }
  px4_msgs__msg__McVirtualAttitudeSetpoint * ros_message = _ros_message;
  {  // timestamp
  ...
  {  // reset_rate_integrals
    PyObject * field = PyObject_GetAttrString(_pymsg, "reset_rate_integrals");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->reset_rate_integrals = (Py_True == field);
    Py_DECREF(field);
  }
  {  // fw_control_yaw
  ...
  {  // apply_spoilers
    PyObject * field = PyObject_GetAttrString(_pymsg, "apply_spoilers");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->apply_spoilers = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4_msgs__msg__mc_virtual_attitude_setpoint__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of McVirtualAttitudeSetpoint */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._mc_virtual_attitude_setpoint");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "McVirtualAttitudeSetpoint");
  ...
  px4_msgs__msg__McVirtualAttitudeSetpoint * ros_message = (px4_msgs__msg__McVirtualAttitudeSetpoint *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
  ...
  {  // reset_rate_integrals
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->reset_rate_integrals ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "reset_rate_integrals", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // apply_spoilers
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->apply_spoilers);
    {
      int rc = PyObject_SetAttrString(_pymessage, "apply_spoilers", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
