...
class Metaclass_EstimatorAidSrcGnssYaw(type):
    """Metaclass of message 'EstimatorAidSrcGnssYaw'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'px4_msgs.msg.EstimatorAidSrcGnssYaw')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__estimator_aid_src_gnss_yaw
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__estimator_aid_src_gnss_yaw
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__estimator_aid_src_gnss_yaw
            cls._TYPE_SUPPORT = module.type_support_msg__msg__estimator_aid_src_gnss_yaw
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__estimator_aid_src_gnss_yaw
...
class EstimatorAidSrcGnssYaw(metaclass=Metaclass_EstimatorAidSrcGnssYaw):
    """Message class 'EstimatorAidSrcGnssYaw'."""
