...
bool px4_msgs__msg__estimator_rng_hgt_bias__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._estimator_rng_hgt_bias.EstimatorRngHgtBias", full_classname_dest, 56) == 0);
  }
  px4_msgs__msg__EstimatorRngHgtBias * ros_message = _ros_message;
  {  // timestamp
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4_msgs__msg__estimator_rng_hgt_bias__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of EstimatorRngHgtBias */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._estimator_rng_hgt_bias");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "EstimatorRngHgtBias");
  ...
  px4_msgs__msg__EstimatorRngHgtBias * ros_message = (px4_msgs__msg__EstimatorRngHgtBias *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
