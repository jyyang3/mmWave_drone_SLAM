...
bool px4_msgs__msg__estimator_aid_src_airspeed__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._estimator_aid_src_airspeed.EstimatorAidSrcAirspeed", full_classname_dest, 64) == 0);
  }
  px4_msgs__msg__EstimatorAidSrcAirspeed * ros_message = _ros_message;
  {  // timestamp
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4_msgs__msg__estimator_aid_src_airspeed__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of EstimatorAidSrcAirspeed */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._estimator_aid_src_airspeed");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "EstimatorAidSrcAirspeed");
  ...
  px4_msgs__msg__EstimatorAidSrcAirspeed * ros_message = (px4_msgs__msg__EstimatorAidSrcAirspeed *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
