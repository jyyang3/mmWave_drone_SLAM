...
bool px4_msgs__msg__vehicle_mocap_odometry__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._vehicle_mocap_odometry.VehicleMocapOdometry", full_classname_dest, 57) == 0);
  }
  px4_msgs__msg__VehicleMocapOdometry * ros_message = _ros_message;
  {  // timestamp
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4_msgs__msg__vehicle_mocap_odometry__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of VehicleMocapOdometry */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._vehicle_mocap_odometry");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VehicleMocapOdometry");
  ...
  px4_msgs__msg__VehicleMocapOdometry * ros_message = (px4_msgs__msg__VehicleMocapOdometry *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
