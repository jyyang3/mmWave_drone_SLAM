...
class Metaclass_EstimatorOdometry(type):
    """Metaclass of message 'EstimatorOdometry'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'px4_msgs.msg.EstimatorOdometry')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__estimator_odometry
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__estimator_odometry
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__estimator_odometry
            cls._TYPE_SUPPORT = module.type_support_msg__msg__estimator_odometry
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__estimator_odometry
    ...
    def POSE_FRAME_UNKNOWN(self):
        ...
        return Metaclass_EstimatorOdometry.__constants['POSE_FRAME_UNKNOWN']

    @property
    def POSE_FRAME_NED(self):
        """Message constant 'POSE_FRAME_NED'."""
        return Metaclass_EstimatorOdometry.__constants['POSE_FRAME_NED']

    @property
    def POSE_FRAME_FRD(self):
        """Message constant 'POSE_FRAME_FRD'."""
        return Metaclass_EstimatorOdometry.__constants['POSE_FRAME_FRD']

    @property
    def VELOCITY_FRAME_UNKNOWN(self):
        """Message constant 'VELOCITY_FRAME_UNKNOWN'."""
        return Metaclass_EstimatorOdometry.__constants['VELOCITY_FRAME_UNKNOWN']

    @property
    def VELOCITY_FRAME_NED(self):
        """Message constant 'VELOCITY_FRAME_NED'."""
        return Metaclass_EstimatorOdometry.__constants['VELOCITY_FRAME_NED']

    @property
    def VELOCITY_FRAME_FRD(self):
        """Message constant 'VELOCITY_FRAME_FRD'."""
        return Metaclass_EstimatorOdometry.__constants['VELOCITY_FRAME_FRD']

    @property
    def VELOCITY_FRAME_BODY_FRD(self):
        """Message constant 'VELOCITY_FRAME_BODY_FRD'."""
        return Metaclass_EstimatorOdometry.__constants['VELOCITY_FRAME_BODY_FRD']


class EstimatorOdometry(metaclass=Metaclass_EstimatorOdometry):
    """
    Message class 'EstimatorOdometry'.
