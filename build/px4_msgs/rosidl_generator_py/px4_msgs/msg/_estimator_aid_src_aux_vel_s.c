...
bool px4_msgs__msg__estimator_aid_src_aux_vel__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._estimator_aid_src_aux_vel.EstimatorAidSrcAuxVel", full_classname_dest, 61) == 0);
  }
  px4_msgs__msg__EstimatorAidSrcAuxVel * ros_message = _ros_message;
  {  // timestamp
  ...
  {  // time_last_fuse
    ...
    }
    {
      ...
      Py_ssize_t size = 3;
      uint64_t * dest = ros_message->time_last_fuse;
  ...
  {  // fusion_enabled
    ...
    {
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'fusion_enabled'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
      Py_ssize_t size = 3;
      bool * dest = ros_message->fusion_enabled;
      for (Py_ssize_t i = 0; i < size; ++i) {
  ...
  {  // innovation_rejected
    ...
    {
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'innovation_rejected'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
      Py_ssize_t size = 3;
      bool * dest = ros_message->innovation_rejected;
      for (Py_ssize_t i = 0; i < size; ++i) {
        PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
        if (!item) {
          Py_DECREF(seq_field);
  ...
  {  // fused
    ...
    {
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'fused'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
      Py_ssize_t size = 3;
      bool * dest = ros_message->fused;
      for (Py_ssize_t i = 0; i < size; ++i) {
        PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
        if (!item) {
          Py_DECREF(seq_field);
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4_msgs__msg__estimator_aid_src_aux_vel__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of EstimatorAidSrcAuxVel */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._estimator_aid_src_aux_vel");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "EstimatorAidSrcAuxVel");
  ...
  px4_msgs__msg__EstimatorAidSrcAuxVel * ros_message = (px4_msgs__msg__EstimatorAidSrcAuxVel *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
  ...
  {  // time_last_fuse
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "time_last_fuse");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    uint64_t * src = &(ros_message->time_last_fuse[0]);
  ...
  {  // fusion_enabled
    PyObject * field = NULL;
    size_t size = 3;
    bool * src = ros_message->fusion_enabled;
  ...
  {  // innovation_rejected
    PyObject * field = NULL;
    size_t size = 3;
    bool * src = ros_message->innovation_rejected;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
