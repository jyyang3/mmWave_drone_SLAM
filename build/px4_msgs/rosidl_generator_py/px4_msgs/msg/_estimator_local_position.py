...
class Metaclass_EstimatorLocalPosition(type):
    """Metaclass of message 'EstimatorLocalPosition'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'px4_msgs.msg.EstimatorLocalPosition')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__estimator_local_position
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__estimator_local_position
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__estimator_local_position
            cls._TYPE_SUPPORT = module.type_support_msg__msg__estimator_local_position
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__estimator_local_position
    ...
    def DIST_BOTTOM_SENSOR_NONE(self):
        ...
        return Metaclass_EstimatorLocalPosition.__constants['DIST_BOTTOM_SENSOR_NONE']

    @property
    def DIST_BOTTOM_SENSOR_RANGE(self):
        """Message constant 'DIST_BOTTOM_SENSOR_RANGE'."""
        return Metaclass_EstimatorLocalPosition.__constants['DIST_BOTTOM_SENSOR_RANGE']

    @property
    def DIST_BOTTOM_SENSOR_FLOW(self):
        """Message constant 'DIST_BOTTOM_SENSOR_FLOW'."""
        return Metaclass_EstimatorLocalPosition.__constants['DIST_BOTTOM_SENSOR_FLOW']


class EstimatorLocalPosition(metaclass=Metaclass_EstimatorLocalPosition):
    """
    Message class 'EstimatorLocalPosition'.
