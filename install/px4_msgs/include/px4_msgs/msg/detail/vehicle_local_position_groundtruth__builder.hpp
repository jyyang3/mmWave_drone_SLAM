...
class Init_VehicleLocalPositionGroundtruth_dead_reckoning
{
public:
  explicit Init_VehicleLocalPositionGroundtruth_dead_reckoning(::px4_msgs::msg::VehicleLocalPositionGroundtruth & msg)
  : msg_(msg)
  {}
  Init_VehicleLocalPositionGroundtruth_vxy_max dead_reckoning(::px4_msgs::msg::VehicleLocalPositionGroundtruth::_dead_reckoning_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_VehicleLocalPositionGroundtruth_dead_reckoning evv(::px4_msgs::msg::VehicleLocalPositionGroundtruth::_evv_type arg)
  {
    msg_.evv = std::move(arg);
    return Init_VehicleLocalPositionGroundtruth_dead_reckoning(msg_);
  }
