...
bool
px4_msgs__msg__EstimatorLocalPosition__are_equal(const px4_msgs__msg__EstimatorLocalPosition * lhs, const px4_msgs__msg__EstimatorLocalPosition * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
px4_msgs__msg__EstimatorLocalPosition__copy(
  const px4_msgs__msg__EstimatorLocalPosition * input,
  px4_msgs__msg__EstimatorLocalPosition * output)
{
  if (!input || !output) {
    return false;
  }
...
px4_msgs__msg__EstimatorLocalPosition__create()
{
  ...
  px4_msgs__msg__EstimatorLocalPosition * msg = (px4_msgs__msg__EstimatorLocalPosition *)allocator.allocate(sizeof(px4_msgs__msg__EstimatorLocalPosition), allocator.state);
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__EstimatorLocalPosition__Sequence__init(px4_msgs__msg__EstimatorLocalPosition__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__EstimatorLocalPosition *)allocator.zero_allocate(size, sizeof(px4_msgs__msg__EstimatorLocalPosition), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  px4_msgs__msg__EstimatorLocalPosition__Sequence * array = (px4_msgs__msg__EstimatorLocalPosition__Sequence *)allocator.allocate(sizeof(px4_msgs__msg__EstimatorLocalPosition__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
px4_msgs__msg__EstimatorLocalPosition__Sequence__are_equal(const px4_msgs__msg__EstimatorLocalPosition__Sequence * lhs, const px4_msgs__msg__EstimatorLocalPosition__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!px4_msgs__msg__EstimatorLocalPosition__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
px4_msgs__msg__EstimatorLocalPosition__Sequence__copy(
  const px4_msgs__msg__EstimatorLocalPosition__Sequence * input,
  px4_msgs__msg__EstimatorLocalPosition__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(px4_msgs__msg__EstimatorLocalPosition);
    px4_msgs__msg__EstimatorLocalPosition * data =
      (px4_msgs__msg__EstimatorLocalPosition *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!px4_msgs__msg__EstimatorLocalPosition__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          px4_msgs__msg__EstimatorLocalPosition__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!px4_msgs__msg__EstimatorLocalPosition__copy(
