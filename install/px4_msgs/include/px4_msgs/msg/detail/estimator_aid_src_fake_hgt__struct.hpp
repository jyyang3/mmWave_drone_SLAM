...
#ifndef PX4_MSGS__MSG__DETAIL__ESTIMATOR_AID_SRC_FAKE_HGT__STRUCT_HPP_
#define PX4_MSGS__MSG__DETAIL__ESTIMATOR_AID_SRC_FAKE_HGT__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__px4_msgs__msg__EstimatorAidSrcFakeHgt __attribute__((deprecated))
#else
# define DEPRECATED__px4_msgs__msg__EstimatorAidSrcFakeHgt __declspec(deprecated)
#endif
...
struct EstimatorAidSrcFakeHgt_
{
  using Type = EstimatorAidSrcFakeHgt_<ContainerAllocator>;

  explicit EstimatorAidSrcFakeHgt_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
  ...
  explicit EstimatorAidSrcFakeHgt_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
  ...
  // pointer types
  using RawPtr =
    px4_msgs::msg::EstimatorAidSrcFakeHgt_<ContainerAllocator> *;
  using ConstRawPtr =
    const px4_msgs::msg::EstimatorAidSrcFakeHgt_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<px4_msgs::msg::EstimatorAidSrcFakeHgt_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<px4_msgs::msg::EstimatorAidSrcFakeHgt_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      px4_msgs::msg::EstimatorAidSrcFakeHgt_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<px4_msgs::msg::EstimatorAidSrcFakeHgt_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<px4_msgs::msg::EstimatorAidSrcFakeHgt_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<px4_msgs::msg::EstimatorAidSrcFakeHgt_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<px4_msgs::msg::EstimatorAidSrcFakeHgt_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__px4_msgs__msg__EstimatorAidSrcFakeHgt
    std::shared_ptr<px4_msgs::msg::EstimatorAidSrcFakeHgt_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__px4_msgs__msg__EstimatorAidSrcFakeHgt
    std::shared_ptr<px4_msgs::msg::EstimatorAidSrcFakeHgt_<ContainerAllocator> const>
  ...
  bool operator==(const EstimatorAidSrcFakeHgt_ & other) const
  {
...
using EstimatorAidSrcFakeHgt =
  px4_msgs::msg::EstimatorAidSrcFakeHgt_<std::allocator<void>>;
...
#endif  // PX4_MSGS__MSG__DETAIL__ESTIMATOR_AID_SRC_FAKE_HGT__STRUCT_HPP_
