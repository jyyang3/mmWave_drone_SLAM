...
#include <stddef.h>
#include "px4_msgs/msg/detail/estimator_optical_flow_vel__rosidl_typesupport_introspection_c.h"
...
void EstimatorOpticalFlowVel__rosidl_typesupport_introspection_c__EstimatorOpticalFlowVel_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  px4_msgs__msg__EstimatorOpticalFlowVel__init(message_memory);
}

void EstimatorOpticalFlowVel__rosidl_typesupport_introspection_c__EstimatorOpticalFlowVel_fini_function(void * message_memory)
{
  px4_msgs__msg__EstimatorOpticalFlowVel__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember EstimatorOpticalFlowVel__rosidl_typesupport_introspection_c__EstimatorOpticalFlowVel_message_member_array[8] = {
  {
    "timestamp",  // name
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(px4_msgs__msg__EstimatorOpticalFlowVel, gyro_rate),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers EstimatorOpticalFlowVel__rosidl_typesupport_introspection_c__EstimatorOpticalFlowVel_message_members = {
  ...
  EstimatorOpticalFlowVel__rosidl_typesupport_introspection_c__EstimatorOpticalFlowVel_init_function,  // function to initialize message memory (memory has to be allocated)
  EstimatorOpticalFlowVel__rosidl_typesupport_introspection_c__EstimatorOpticalFlowVel_fini_function  // function to terminate message instance (will not free memory)
};
