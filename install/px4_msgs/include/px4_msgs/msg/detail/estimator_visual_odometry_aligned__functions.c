...
bool
px4_msgs__msg__EstimatorVisualOdometryAligned__are_equal(const px4_msgs__msg__EstimatorVisualOdometryAligned * lhs, const px4_msgs__msg__EstimatorVisualOdometryAligned * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
px4_msgs__msg__EstimatorVisualOdometryAligned__copy(
  const px4_msgs__msg__EstimatorVisualOdometryAligned * input,
  px4_msgs__msg__EstimatorVisualOdometryAligned * output)
{
  if (!input || !output) {
    return false;
  }
...
px4_msgs__msg__EstimatorVisualOdometryAligned__create()
{
  ...
  px4_msgs__msg__EstimatorVisualOdometryAligned * msg = (px4_msgs__msg__EstimatorVisualOdometryAligned *)allocator.allocate(sizeof(px4_msgs__msg__EstimatorVisualOdometryAligned), allocator.state);
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__EstimatorVisualOdometryAligned__Sequence__init(px4_msgs__msg__EstimatorVisualOdometryAligned__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__EstimatorVisualOdometryAligned *)allocator.zero_allocate(size, sizeof(px4_msgs__msg__EstimatorVisualOdometryAligned), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  px4_msgs__msg__EstimatorVisualOdometryAligned__Sequence * array = (px4_msgs__msg__EstimatorVisualOdometryAligned__Sequence *)allocator.allocate(sizeof(px4_msgs__msg__EstimatorVisualOdometryAligned__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
px4_msgs__msg__EstimatorVisualOdometryAligned__Sequence__are_equal(const px4_msgs__msg__EstimatorVisualOdometryAligned__Sequence * lhs, const px4_msgs__msg__EstimatorVisualOdometryAligned__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!px4_msgs__msg__EstimatorVisualOdometryAligned__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
px4_msgs__msg__EstimatorVisualOdometryAligned__Sequence__copy(
  const px4_msgs__msg__EstimatorVisualOdometryAligned__Sequence * input,
  px4_msgs__msg__EstimatorVisualOdometryAligned__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(px4_msgs__msg__EstimatorVisualOdometryAligned);
    px4_msgs__msg__EstimatorVisualOdometryAligned * data =
      (px4_msgs__msg__EstimatorVisualOdometryAligned *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!px4_msgs__msg__EstimatorVisualOdometryAligned__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          px4_msgs__msg__EstimatorVisualOdometryAligned__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!px4_msgs__msg__EstimatorVisualOdometryAligned__copy(
