...
constexpr uint8_t VehicleGpsPosition_<ContainerAllocator>::JAMMING_STATE_UNKNOWN;
template<typename ContainerAllocator>
constexpr uint8_t VehicleGpsPosition_<ContainerAllocator>::JAMMING_STATE_OK;
template<typename ContainerAllocator>
constexpr uint8_t VehicleGpsPosition_<ContainerAllocator>::JAMMING_STATE_WARNING;
template<typename ContainerAllocator>
constexpr uint8_t VehicleGpsPosition_<ContainerAllocator>::JAMMING_STATE_CRITICAL;
