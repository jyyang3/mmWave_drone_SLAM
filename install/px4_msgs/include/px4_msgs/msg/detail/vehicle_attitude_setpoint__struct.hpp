...
template<typename ContainerAllocator>
constexpr uint8_t VehicleAttitudeSetpoint_<ContainerAllocator>::SPOILERS_OFF;
template<typename ContainerAllocator>
constexpr uint8_t VehicleAttitudeSetpoint_<ContainerAllocator>::SPOILERS_LAND;
template<typename ContainerAllocator>
constexpr uint8_t VehicleAttitudeSetpoint_<ContainerAllocator>::SPOILERS_DESCEND;
