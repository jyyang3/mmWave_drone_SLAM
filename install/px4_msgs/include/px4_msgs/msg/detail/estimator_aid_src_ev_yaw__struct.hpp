...
#ifndef PX4_MSGS__MSG__DETAIL__ESTIMATOR_AID_SRC_EV_YAW__STRUCT_HPP_
#define PX4_MSGS__MSG__DETAIL__ESTIMATOR_AID_SRC_EV_YAW__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__px4_msgs__msg__EstimatorAidSrcEvYaw __attribute__((deprecated))
#else
# define DEPRECATED__px4_msgs__msg__EstimatorAidSrcEvYaw __declspec(deprecated)
#endif
...
struct EstimatorAidSrcEvYaw_
{
  using Type = EstimatorAidSrcEvYaw_<ContainerAllocator>;

  explicit EstimatorAidSrcEvYaw_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
  ...
  explicit EstimatorAidSrcEvYaw_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
  ...
  // pointer types
  using RawPtr =
    px4_msgs::msg::EstimatorAidSrcEvYaw_<ContainerAllocator> *;
  using ConstRawPtr =
    const px4_msgs::msg::EstimatorAidSrcEvYaw_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<px4_msgs::msg::EstimatorAidSrcEvYaw_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<px4_msgs::msg::EstimatorAidSrcEvYaw_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      px4_msgs::msg::EstimatorAidSrcEvYaw_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<px4_msgs::msg::EstimatorAidSrcEvYaw_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<px4_msgs::msg::EstimatorAidSrcEvYaw_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<px4_msgs::msg::EstimatorAidSrcEvYaw_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<px4_msgs::msg::EstimatorAidSrcEvYaw_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__px4_msgs__msg__EstimatorAidSrcEvYaw
    std::shared_ptr<px4_msgs::msg::EstimatorAidSrcEvYaw_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__px4_msgs__msg__EstimatorAidSrcEvYaw
    std::shared_ptr<px4_msgs::msg::EstimatorAidSrcEvYaw_<ContainerAllocator> const>
  ...
  bool operator==(const EstimatorAidSrcEvYaw_ & other) const
  {
...
using EstimatorAidSrcEvYaw =
  px4_msgs::msg::EstimatorAidSrcEvYaw_<std::allocator<void>>;
...
#endif  // PX4_MSGS__MSG__DETAIL__ESTIMATOR_AID_SRC_EV_YAW__STRUCT_HPP_
