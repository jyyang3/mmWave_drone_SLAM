...
bool px4_msgs__msg__estimator_visual_odometry_aligned__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._estimator_visual_odometry_aligned.EstimatorVisualOdometryAligned", full_classname_dest, 78) == 0);
  }
  px4_msgs__msg__EstimatorVisualOdometryAligned * ros_message = _ros_message;
  {  // timestamp
  ...
  {  // reset_counter
    PyObject * field = PyObject_GetAttrString(_pymsg, "reset_counter");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4_msgs__msg__estimator_visual_odometry_aligned__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of EstimatorVisualOdometryAligned */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._estimator_visual_odometry_aligned");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "EstimatorVisualOdometryAligned");
  ...
  px4_msgs__msg__EstimatorVisualOdometryAligned * ros_message = (px4_msgs__msg__EstimatorVisualOdometryAligned *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
