...
bool px4_msgs__msg__estimator_gnss_hgt_bias__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._estimator_gnss_hgt_bias.EstimatorGnssHgtBias", full_classname_dest, 58) == 0);
  }
  px4_msgs__msg__EstimatorGnssHgtBias * ros_message = _ros_message;
  {  // timestamp
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4_msgs__msg__estimator_gnss_hgt_bias__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of EstimatorGnssHgtBias */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._estimator_gnss_hgt_bias");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "EstimatorGnssHgtBias");
  ...
  px4_msgs__msg__EstimatorGnssHgtBias * ros_message = (px4_msgs__msg__EstimatorGnssHgtBias *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
