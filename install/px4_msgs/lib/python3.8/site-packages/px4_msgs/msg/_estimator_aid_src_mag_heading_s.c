...
bool px4_msgs__msg__estimator_aid_src_mag_heading__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._estimator_aid_src_mag_heading.EstimatorAidSrcMagHeading", full_classname_dest, 69) == 0);
  }
  px4_msgs__msg__EstimatorAidSrcMagHeading * ros_message = _ros_message;
  {  // timestamp
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4_msgs__msg__estimator_aid_src_mag_heading__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of EstimatorAidSrcMagHeading */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._estimator_aid_src_mag_heading");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "EstimatorAidSrcMagHeading");
  ...
  px4_msgs__msg__EstimatorAidSrcMagHeading * ros_message = (px4_msgs__msg__EstimatorAidSrcMagHeading *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
