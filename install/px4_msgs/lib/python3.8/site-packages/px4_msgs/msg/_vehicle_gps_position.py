...
class Metaclass_VehicleGpsPosition(type):
    """Metaclass of message 'VehicleGpsPosition'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'px4_msgs.msg.VehicleGpsPosition')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__vehicle_gps_position
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__vehicle_gps_position
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__vehicle_gps_position
            cls._TYPE_SUPPORT = module.type_support_msg__msg__vehicle_gps_position
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__vehicle_gps_position
    ...
    def JAMMING_STATE_UNKNOWN(self):
        ...
        return Metaclass_VehicleGpsPosition.__constants['JAMMING_STATE_UNKNOWN']

    @property
    def JAMMING_STATE_OK(self):
        """Message constant 'JAMMING_STATE_OK'."""
        return Metaclass_VehicleGpsPosition.__constants['JAMMING_STATE_OK']

    @property
    def JAMMING_STATE_WARNING(self):
        """Message constant 'JAMMING_STATE_WARNING'."""
        return Metaclass_VehicleGpsPosition.__constants['JAMMING_STATE_WARNING']

    @property
    def JAMMING_STATE_CRITICAL(self):
        """Message constant 'JAMMING_STATE_CRITICAL'."""
        return Metaclass_VehicleGpsPosition.__constants['JAMMING_STATE_CRITICAL']


class VehicleGpsPosition(metaclass=Metaclass_VehicleGpsPosition):
    """
    Message class 'VehicleGpsPosition'.
