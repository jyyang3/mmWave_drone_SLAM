...
class Metaclass_VehicleLocalPositionGroundtruth(type):
    """Metaclass of message 'VehicleLocalPositionGroundtruth'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'px4_msgs.msg.VehicleLocalPositionGroundtruth')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__vehicle_local_position_groundtruth
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__vehicle_local_position_groundtruth
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__vehicle_local_position_groundtruth
            cls._TYPE_SUPPORT = module.type_support_msg__msg__vehicle_local_position_groundtruth
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__vehicle_local_position_groundtruth
    ...
    def DIST_BOTTOM_SENSOR_NONE(self):
        ...
        return Metaclass_VehicleLocalPositionGroundtruth.__constants['DIST_BOTTOM_SENSOR_NONE']

    @property
    def DIST_BOTTOM_SENSOR_RANGE(self):
        """Message constant 'DIST_BOTTOM_SENSOR_RANGE'."""
        return Metaclass_VehicleLocalPositionGroundtruth.__constants['DIST_BOTTOM_SENSOR_RANGE']

    @property
    def DIST_BOTTOM_SENSOR_FLOW(self):
        """Message constant 'DIST_BOTTOM_SENSOR_FLOW'."""
        return Metaclass_VehicleLocalPositionGroundtruth.__constants['DIST_BOTTOM_SENSOR_FLOW']


class VehicleLocalPositionGroundtruth(metaclass=Metaclass_VehicleLocalPositionGroundtruth):
    """
    Message class 'VehicleLocalPositionGroundtruth'.
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'delta_xy' field must be a set or sequence with length 2 and each value of type 'float'"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 True), \
                "The 'delta_vxy' field must be a set or sequence with length 2 and each value of type 'float'"
