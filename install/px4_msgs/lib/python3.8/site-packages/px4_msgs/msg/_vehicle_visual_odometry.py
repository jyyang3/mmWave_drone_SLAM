...
class Metaclass_VehicleVisualOdometry(type):
    ...
    def POSE_FRAME_UNKNOWN(self):
        ...
        return Metaclass_VehicleVisualOdometry.__constants['POSE_FRAME_UNKNOWN']

    @property
    def POSE_FRAME_NED(self):
        """Message constant 'POSE_FRAME_NED'."""
        return Metaclass_VehicleVisualOdometry.__constants['POSE_FRAME_NED']

    @property
    def POSE_FRAME_FRD(self):
        """Message constant 'POSE_FRAME_FRD'."""
        return Metaclass_VehicleVisualOdometry.__constants['POSE_FRAME_FRD']

    @property
    def VELOCITY_FRAME_UNKNOWN(self):
        """Message constant 'VELOCITY_FRAME_UNKNOWN'."""
        return Metaclass_VehicleVisualOdometry.__constants['VELOCITY_FRAME_UNKNOWN']

    @property
    def VELOCITY_FRAME_NED(self):
        """Message constant 'VELOCITY_FRAME_NED'."""
        return Metaclass_VehicleVisualOdometry.__constants['VELOCITY_FRAME_NED']

    @property
    def VELOCITY_FRAME_FRD(self):
        """Message constant 'VELOCITY_FRAME_FRD'."""
        return Metaclass_VehicleVisualOdometry.__constants['VELOCITY_FRAME_FRD']

    @property
    def VELOCITY_FRAME_BODY_FRD(self):
        """Message constant 'VELOCITY_FRAME_BODY_FRD'."""
        return Metaclass_VehicleVisualOdometry.__constants['VELOCITY_FRAME_BODY_FRD']
