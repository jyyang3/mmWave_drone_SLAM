...
class Metaclass_McVirtualAttitudeSetpoint(type):
    """Metaclass of message 'McVirtualAttitudeSetpoint'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'px4_msgs.msg.McVirtualAttitudeSetpoint')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__mc_virtual_attitude_setpoint
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__mc_virtual_attitude_setpoint
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__mc_virtual_attitude_setpoint
            cls._TYPE_SUPPORT = module.type_support_msg__msg__mc_virtual_attitude_setpoint
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__mc_virtual_attitude_setpoint
    ...
    def FLAPS_OFF(self):
        ...
        return Metaclass_McVirtualAttitudeSetpoint.__constants['FLAPS_OFF']

    @property
    def FLAPS_LAND(self):
        """Message constant 'FLAPS_LAND'."""
        return Metaclass_McVirtualAttitudeSetpoint.__constants['FLAPS_LAND']

    @property
    def FLAPS_TAKEOFF(self):
        """Message constant 'FLAPS_TAKEOFF'."""
        return Metaclass_McVirtualAttitudeSetpoint.__constants['FLAPS_TAKEOFF']

    @property
    def SPOILERS_OFF(self):
        """Message constant 'SPOILERS_OFF'."""
        return Metaclass_McVirtualAttitudeSetpoint.__constants['SPOILERS_OFF']

    @property
    def SPOILERS_LAND(self):
        """Message constant 'SPOILERS_LAND'."""
        return Metaclass_McVirtualAttitudeSetpoint.__constants['SPOILERS_LAND']

    @property
    def SPOILERS_DESCEND(self):
        """Message constant 'SPOILERS_DESCEND'."""
        return Metaclass_McVirtualAttitudeSetpoint.__constants['SPOILERS_DESCEND']


class McVirtualAttitudeSetpoint(metaclass=Metaclass_McVirtualAttitudeSetpoint):
    """
    Message class 'McVirtualAttitudeSetpoint'.
    ...
    def __init__(self, **kwargs):
        ...
        self.reset_rate_integrals = kwargs.get('reset_rate_integrals', bool())
    ...
    def __eq__(self, other):
        ...
        if all(self.thrust_body != other.thrust_body):
            return False
        if self.reset_rate_integrals != other.reset_rate_integrals:
            return False
    ...
    @property
    def reset_rate_integrals(self):
        """Message field 'reset_rate_integrals'."""
        return self._reset_rate_integrals

    @reset_rate_integrals.setter
    def reset_rate_integrals(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'reset_rate_integrals' field must be of type 'bool'"
        self._reset_rate_integrals = value
